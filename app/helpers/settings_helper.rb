...
module SettingsHelper
  ...
  def membership_settings_items
    [
      ...
      { category: 'Membership', title: 'Applications',
        desc: 'Applications, groups, and member application assignments.', path: applications_path },
      { category: 'Membership', title: 'Application group defaults',
      ...
      { category: 'Membership', title: 'Membership settings',
  ...
  def access_settings_items
    [
      { category: 'Access & hardware', title: 'Access controllers',
  ...
  def payment_settings_items
    [
      { category: 'Payments', title: 'Payment processors',
  ...
  def communication_settings_items
    [
      ...
      { category: 'Communications', title: 'Nags',
        desc: 'Automated member reminders with preview of who would be emailed.', path: nag_settings_path,
        attention_count: settings_attention_counts[:nags_due] },
      ...
      { category: 'Communications', title: 'Login branding',
  ...
  def profile_settings_items
    [
      { category: 'Member profiles', title: 'Interests',
      ...
      { category: 'Member profiles', title: 'Map defaults',
  ...
  def integration_settings_items
    [
      { category: 'AI & integrations', title: 'AI services',
      ...
      { category: 'AI & integrations', title: 'AI providers',
        desc: 'Reusable AI provider URLs and optional API keys.', path: ai_providers_path },
      { category: 'AI & integrations', title: 'Member sources',
